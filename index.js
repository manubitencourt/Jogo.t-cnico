...
function fase7(){
   ...
   let faltar = prompt("Você acordou muito cansada, e está pensando se vai faltar o treino, você vai?").toLowerCase()
   if (faltar == "sim"){
...
function fase8(){
    ...
    alert("Daniel e sua esposa decidiram fazer uma surpresa para te recompensar pelo sei esforço nos ultimos tempos na canoagem.")
...
function fase9(){
    ...
    console.log("Seu treinador comentou que tem um grupo de refugiados que está também treinando para as olímpiadas, ele te candidatou de surpresa, agora você tem que ir fazer o teste")
...
if (decisaoFinal == "sim" & vida >= 50){
    console.log("VOCÊ GANHOU PRIMEIRO LUGAR NAS OLÍMÍADAS 2024, MEUS PARABÉNS")
}
